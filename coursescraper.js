...
async function generateCSV() {
          ...
          if ($(".t_mezuniyet")) {
            ...
            $(".t_mezuniyet").find("tbody").eq(1).children().each((index, element) => {
              ...
              const codeForUs = (() => {
                ...
                if (text === "University Courses") return "D";
                else if (text === "Internship") return "I";
                else if (text === "Seminar") return "S";
                else if (text === "Required") return "R";
                else if (text === "Required Courses") return "R";
                else if (text === "Required Courses (Area of Management)") return "RM";
                else if (text === "Required Courses (Area of Engineering)") return "RE";
                else if (text === "Required Course") return "R";
                else if (text === "Mathematics Requirement Courses") return "MR";
                else if (text === "Philosophy Requirement Course") return "PR";
                else if (text === "Elective Courses") return "C";
                else if (text === "Electives Courses") return "C";
                else if (text === "Term Project") return "P";
                else if (text === "Project Course") return "P";
                else if (text === "Project") return "P";
                else if (text === "Graduation Project") return "P";
                else if (text === "PhD Dissertation") return "DS";
                else if (text === "PhD. Thesis") return "DT";
                else if (text === "Ph.D. Thesis") return "DT";
                else if (text === "PhD Thesis") return "DT";
                else if (text === "Thesis Course") return "DT";
                else if (text === "Professional Development Seminars") return "PDS";
                else if (text === "Area Core Courses (Management and Organization Area)") return "AM";
                else if (text === "Area Core Courses (M") return "AM";
                else if (text === "Core Courses (Management and Organization Area)") return "CM";
                else if (text === "Core Courses (Operations Management Area)") return "CO";
                else if (text === "Elective Courses (Management and Organization Area)") return "AM";
                else if (text === "Elective Courses (Operations Management Area)") return "AO";
                else if (text === "FENS Graduate Courses") return "DF";
                else if (text === "Managerial Skills Workshop") return "MW";
                else if (text === "Managerial Skill Workshops") return "MW";
                else if (text === "Managerial Skills Workshops") return "MW";
                else if (text === "Project (Area of Management)") return "PM";
                else if (text === "Project (Area of Engineering)") return "PE";
                else if (text === "Practicing Finance") return "PF";
                else if (text === "Practicing Finance") return "PF";
                else if (text === "Practicing Finance") return "PF";
                else if (text === "Practicing Finance") return "PF";
                else if (text === "Master Thesis") return "T";
                else if (text === "Master Thesis / Studio Project") return "T";
                else if (text === "Core Electives") return "C";
                else if (text === "Core Elective") return "C";
                else if (text === "Core Electives (Area of Management)") return "CM";
                else if (text === "Core Electives (Area of Engineering)") return "CE";
                else if (text === "Core Electives (Area of Management) *") return "CM";
                else if (text === "Core Electives (Area of Engineering) *") return "CE";
                else if (text === "Core Courses") return "C";
                else if (text === "Core Area Courses") return "C";
                else if (text === "Area Core Courses") return "C";
                else if (text === "Core Elective Courses") return "C";
                else if (text === "Core Electives 1") return "CI";
                else if (text === "Core Electives 2") return "CII";
                else if (text.startsWith("Core Elective I")) return "C" + text.substring(text.indexOf("I"), text.indexOf(" ", text.indexOf("I"))).trim();
                else if (text.startsWith("Core Electives I")) return "C" + text.substring(text.indexOf("I"), text.indexOf(" ", text.indexOf("I"))).trim();
                else if (text === "Area Electives") return "A";
                else if (text === "Area Electives (Area of Engineering)") return "AE";
                else if (text === "Area Electives (Area of Management)") return "AM";
                else if (text === "Area Electives (Area of Engineering) *") return "AE";
                else if (text === "Area Electives (Area of Management) *") return "AM";
                else if (text === "Area Elective") return "A";
                else if (text === "Area Courses") return "A";
                else if (text === "Area Elective Courses") return "A";
                else if (text === "Free Elective Courses") return "F";
                else if (text === "Free Electives") return "F";
                else if (text === "Free Elective") return "F";
  ...
  for (const major of allMajors) {
    ...
    broadcastToAllWindows("scraper-information", { h: "Getting major details...", t: major.name, p: 0 });
  ...
  for (const major of doubleMajors) {
    if (continueOnMajor && major.code !== continueOnMajor) continue;
    if (continueOnMajor && major.code === continueOnMajor) continueOnMajor = undefined;
    if (getOnlyMajor && major.code !== getOnlyMajor) continue;
    broadcastToAllWindows("scraper-information", { h: "Getting double major details...", t: major.name, p: 0 });
    const majordata = await getMajorDetails(major.code, "UG");
  ...
  for (const major of allMinors) {
    if (continueOnMajor && major.code !== continueOnMajor) continue;
    if (continueOnMajor && major.code === continueOnMajor) continueOnMajor = undefined;
    if (getOnlyMajor && major.code !== getOnlyMajor) continue;
    broadcastToAllWindows("scraper-information", { h: "Getting minor details...", t: major.name, p: 0 });
    const majordata = await getMajorDetails(major.code, "UG");
